...
def donwload_dataset(save_path, url) :

    # Set the number of bytes to download per iteration (e.g. 4MB)
    bytes_per_iteration = 20 * 1024 * 1024
...
# call download_dataset function
# make sure to catch any errors and retry after 3 seconds
# wait 60 seconds before retrying
# repeat this process until the download is complete
while True:
    try:
        donwload_dataset(save_path, url)
        break
